...
public abstract class AbstractBroadleafTagTextModifierProcessor extends AbstractTextChildModifierAttrProcessor {
    ...
    protected String getText(Arguments arguments, Element element, String attributeName) {
        ...
        return getTagText(tagName, tagAttributes, attributeName, element.getAttributeValue(attributeName), context);
    }
