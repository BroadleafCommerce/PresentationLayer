 ...
 * @author Jeff Fischer
 */
public class BroadleafThymeleaf2BindStatus implements BroadleafBindStatus {

    protected BindStatus bindStatus;

    public BroadleafThymeleaf2BindStatus(BindStatus bindStatus) {
