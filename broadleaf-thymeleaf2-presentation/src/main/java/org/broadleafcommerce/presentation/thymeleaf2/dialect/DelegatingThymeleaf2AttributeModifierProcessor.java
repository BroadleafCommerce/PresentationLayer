...
public class DelegatingThymeleaf2AttributeModifierProcessor extends AbstractAttributeModifierAttrProcessor {
    ...
    protected Map<String, String> getModifiedAttributeValues(Arguments arguments, Element element, String attributeName) {
        ...
        BroadleafAttributeModifier modifications = processor.getModifiedAttributes(tagName, tagAttributes, attributeName, element.getAttributeValue(attributeName), context);
