...
public class Thymeleaf3ConfigUtils {
    ...
    protected DelegatingThymeleaf3TagReplacementProcessor createDelegatingTagReplacementProcessor(
    ...
    protected DelegatingThymeleaf3ModelModifierProcessor createDelegatingFormReplacementProcessor(
    ...
    protected DelegatingThymeleaf3AttributeModifierProcessor createDelegatingAttributeModifierProcessor(
    ...
    protected BroadleafThymeleaf3DatabaseTemplateResolver createDatabaseTemplateResolver(
            BroadleafTemplateResolver resolver
    ) {
        ...
        databaseResolver.setResourceResolverExtensionManager(applicationContext.getBean(
                "blDatabaseResourceResolverExtensionManager", DatabaseResourceResolverExtensionManager.class)
        );
        databaseResolver.setBroadleafContextUtil(applicationContext.getBean(
                "blBroadleafContextUtil", BroadleafContextUtil.class)
        );
        return databaseResolver;
    }

    protected BroadleafThymeleaf3ThemeAwareTemplateResolver createServletTemplateResolver(
            BroadleafTemplateResolver resolver
    ) {
        BroadleafThymeleaf3ThemeAwareTemplateResolver servletResolver = applicationContext.getAutowireCapableBeanFactory()
                .createBean(BroadleafThymeleaf3ThemeAwareTemplateResolver.class);
    ...
    protected DelegatingThymeleaf3TemplateResolver createDelegatingThymeleaf3TemplateResolver(
            BroadleafTemplateResolver resolver
    ) {
        DelegatingThymeleaf3TemplateResolver delegatingResolver = applicationContext.getAutowireCapableBeanFactory()
                .createBean(DelegatingThymeleaf3TemplateResolver.class);
    ...
    protected void commonTemplateResolver(
            BroadleafTemplateResolver blResolver,
            AbstractConfigurableTemplateResolver tlResolver
    ) {
