 ...
 *
 */
public class BroadleafThymeleaf3StandaloneElementImpl implements BroadleafThymeleaf3TemplateEvent {

    protected IStandaloneElementTag standaloneTag;

    public BroadleafThymeleaf3StandaloneElementImpl(IStandaloneElementTag standaloneTag) {
