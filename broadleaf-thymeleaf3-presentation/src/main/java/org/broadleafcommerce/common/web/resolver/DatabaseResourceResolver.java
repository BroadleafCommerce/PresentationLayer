 ...
 */
public class DatabaseResourceResolver implements ITemplateResource {
    
    protected DatabaseResourceResolverExtensionManager extensionManager;
    protected String path;
    
    public DatabaseResourceResolver(DatabaseResourceResolverExtensionManager extensionManager, String path) {
