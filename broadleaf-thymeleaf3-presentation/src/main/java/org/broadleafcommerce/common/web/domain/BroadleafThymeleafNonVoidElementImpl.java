 ...
 *
 */
public class BroadleafThymeleafNonVoidElementImpl implements BroadleafThymeleafNonVoidElement, BroadleafThymeleafTemplateEvent {
    ...
    protected ArrayList<BroadleafThymeleafElement> children;

    public BroadleafThymeleafNonVoidElementImpl(IOpenElementTag openTag, ICloseElementTag closeTag) {
    ...
    public ArrayList<ITemplateEvent> getAllTags() {
        ...
        for (BroadleafThymeleafElement elem : this.children) {
            tags.addAll(((BroadleafThymeleafTemplateEvent) elem).getAllTags());
        }
