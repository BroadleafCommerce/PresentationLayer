 ...
 *
 */
public class BroadleafThymeleafStandaloneElementImpl implements BroadleafThymeleafTemplateEvent {

    protected IStandaloneElementTag standaloneTag;

    public BroadleafThymeleafStandaloneElementImpl(IStandaloneElementTag standaloneTag) {
